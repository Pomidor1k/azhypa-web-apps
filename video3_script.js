...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    .then(data => {
        if (data.data === 'pro') {
            ...
            videoSrc.setAttribute("src", "https://949321.selcdn.ru/azhypa-videos/LESSON_03_PRO_1.mp4");
        } else if (data.data === 'advanced') {
            const videoSrc = document.querySelector('#video_src')
            videoSrc.setAttribute("src", "https://949321.selcdn.ru/azhypa-videos/LESSON_03_ADV.mp4");
        } else if (data.data === 'basic') {
            const videoSrc = document.querySelector('#video_src')
            videoSrc.setAttribute("src", "https://949321.selcdn.ru/azhypa-videos/LESSON_03_BASIC.mp4");
        } else {
            const videoSrc = document.querySelector('#video_src')
            videoSrc.setAttribute("src", "https://949321.selcdn.ru/azhypa-videos/LESSON_03_BASIC.mp4");
        }
